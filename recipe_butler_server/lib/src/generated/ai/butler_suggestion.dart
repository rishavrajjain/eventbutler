...
import 'package:recipe_butler_server/src/generated/protocol.dart' as _i4;

abstract class ButlerSuggestion
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      '__className__': 'ButlerSuggestion',
      'message': message,
      'shopping': shopping.toJson(valueToJson: (v) => v.toJsonForProtocol()),
