...
--
-- Class RecipeStep as table recipe_step
--
...
--
-- Class ShoppingListMember as table shopping_list_member
--
...
--
-- Class TaskMessage as table task_message
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('recipe_butler', '20260127092520256', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260127092520256', "timestamp" = now();
