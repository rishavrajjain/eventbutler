...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Brand Yellow color from the design/MASTER_PLAN if available,
    // otherwise approximating a nice yellow or using the one from AppTheme if imported.
    // Hardcoding here as per plan or using a Color literal.
            ...
            child: Column(
              ...
              children: [
                ...
                Image.asset(
                  ...
                  height: 120, // Adjusted height for aesthetics
                ),
